...
def main():
    ...
    for k in range(10):
        dataset_name = f'small-{k}-peak-terrain-full'
        train_data_name=f'artificial/small-k-{k}-train-full.npz'
        test_data_name = f'artificial/small-k-{k}-test-10.npz'
        # Load data 
        ...
        for modelname in model_configs:
            ...
            loss_data.append({'k': k, 'modelname':modelname, 'loss':output[-1]})
